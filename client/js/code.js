...
if ($(window).width() > 500) {
    ...
    */
    ...
    $('.right').click(function (){
        ...
        console.log('click on right! emit relative id '+clickedTagID);
    ...
    */
    ...
    (function (exports){
        ...
        socket.on('connect', function (data) {
            socket.emit('storeClientInfo', { customId:"000_codeJS_0000" });
        });
        ...
        socket.on('client-right', function (data) {
            console.log('codejs client  slide to right ' + data);
            oneMore();
        });
        socket.on('client-refresh', function (data) {
